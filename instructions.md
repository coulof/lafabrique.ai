...
* Visual identity:
  ...
  * Several banners are provided each with a main color (Blue, Red, Yellow)
    * When a user first land to the page his session and theme will have the color
    * Upon reload the color will change
* Behavior:
  * Smooth **scrolling between sections** of the landing page
  * It should show a light paralax effect between the characters and the background
...
## Hosting
* Host the website with a cloudfront worker
* Have the option to run as a docker container